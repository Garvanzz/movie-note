...
const ALL_TABLES: [&str; 18] = [
    "movies", "code_aliases", "actors", "actor_aliases",
...
pub fn import_all_data(db: State<Database>, data: Value) -> Result<usize, String> {
    ...
    let ordered_tables = [
        ...
        "movies", "code_aliases", "actor_aliases", "actor_tags",
